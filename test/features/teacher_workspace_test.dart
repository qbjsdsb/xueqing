...
void main() {
  ...
  testWidgets('updates autogenerated next action title after repeated type changes', (
    tester,
  ) async {
    final repository = _FakeLearningRepository(
      _fixtureWorkspace(status: LearningCaseStatus.confirmed),
    ...
    expect(repository.completeCount, 1);
    expect(repository.completeCommands.single.nextActionType, CaseActionType.review);
