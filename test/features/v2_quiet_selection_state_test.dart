...
void main() {
  testWidgets(
    'desktop rail selection changes only its quiet surface layer',
    (tester) async {
      ...
      Finder railMaterial() => find.descendant(
        of: studentRail(),
        matching: find.byType(Material),
      );
      Finder railIcon() => find.descendant(
        of: studentRail(),
        matching: find.byType(Icon),
      );
      Finder railLabel() => find.descendant(
        of: studentRail(),
        matching: find.text('学生'),
      );
