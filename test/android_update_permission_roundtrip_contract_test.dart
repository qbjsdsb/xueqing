...
void main() {
  test(
    'Android update permission returns to the same verified APK install',
    () {
      final native = File(
        'android/app/src/main/kotlin/com/xueqing/app/MainActivity.kt',
      ).readAsStringSync();
      final installer = File('lib/update/update_installer.dart')
          .readAsStringSync();
      ...
      expect(
        native,
        contains('File(cacheDir, "xueqing-updates").canonicalFile'),
      );
