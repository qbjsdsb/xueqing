...
Personal remains the default teaching workspace. Compact Personal keeps exactly three bottom destinations: 今日 / 学生 / 学情. A manager-teacher reaches Organization through a quiet, visibly labeled `机构` header action on Compact touch layouts; Organization is not added as a fourth bottom-navigation item.
