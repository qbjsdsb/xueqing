-- Phase 0B.1-E correction: keep direct Storage uploads on UUIDv4 paths.
--
-- The metadata RPC already requires a uuid attachment id. The Storage policy
-- must enforce the same shape so unregistered objects cannot use arbitrary
-- 36-character path segments.
