-- Phase 0B.0-K: require a live Auth session before accepting an invitation.
-- This is a forward compatibility/security migration for fictional
-- development data. It prevents a still-unexpired revoked JWT from changing
-- organization membership through the invitation acceptance RPC.

create function private.has_live_auth_session_v2()
returns boolean
language sql
stable
security definer
...
revoke all on function private.has_live_auth_session_v2()
